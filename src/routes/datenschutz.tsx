	...
	return (
		<main className="pt-[116px]">
			...
			<p>
				...
				<a href="https://www.strato.de/datenschutz/">https://www.strato.de/datenschutz/</a>. Die Verwendung von Strato erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Wir haben ein berechtigtes Interesse an einer möglichst zuverlässigen Darstellung unserer Website. Sofern eine entsprechende Einwilligung abgefragt wurde, erfolgt die Verarbeitung ausschließlich auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO und § 25 Abs. 1 TTDSG, soweit die Einwilligung die Speicherung von Cookies oder den Zugriff auf Informationen im Endgerät des Nutzers (z. B. Device-Fingerprinting) im Sinne des TTDSG umfasst. Die Einwilligung ist jederzeit widerrufbar.
			</p>
			<br></br>
			<p>
			...
			<p>
				...
				<br></br>
				Mehr über die Daten, die durch die Verwendung von CleverReach verarbeitet werden, erfahren Sie in der Datenschutzerklärung auf{" "}
				<a href="https://www.cleverreach.com/de-de/datenschutz/?tid=331673118835" target="_blank" rel="follow noopener">
			...
			<br></br>
			<p>
				<b>Warum verwenden wir Cookiebot auf unserer Website?</b>
			</p>
			<br></br>
			...
			<br></br>
			<p>
				<b>Welche Daten werden von Cookiebot gespeichert?</b>
			</p>
			<br></br>
			...
			<p>
				<strong>Name:</strong>&nbsp;CookieConsent<br></br> <strong>Wert:</strong>
				&nbsp;stamp:’P7to4eNgIHvJvDerjKneBsmJQd9331673119131-2<br></br> <strong>Verwendungszweck:</strong>&nbsp;In diesem Cookie wird Ihr Zustimmungsstatus, gespeichert. Dadurch kann unsere Website auch bei zukünftigen Besuchen den aktuellen Status lesen und befolgen.<br></br> <strong>Ablaufdatum:</strong>&nbsp;nach einem Jahr
			</p>
			<p>
				<strong>Name:</strong>&nbsp;CookieConsentBulkTicket<br></br> <strong>Wert:</strong>
				&nbsp;kDSPWpA%2fjhljZKClPqsncfR8SveTnNWhys5NojaxdFYBPjZ2PaDnUw%3d%3331673119131-6
				<br></br> <strong>Verwendungszweck:</strong>&nbsp;Dieses Cookie wird gesetzt, wenn Sie alle Cookies erlauben und somit eine “Sammelzustimmung” aktiviert haben. Das Cookie speichert dann eine eigene, zufällige und eindeutige ID.<br></br> <strong>Ablaufdatum:&nbsp;</strong>nach einem Jahr
			</p>
			<p>
				<strong>Anmerkung: </strong>Bitte bedenken Sie, dass es sich hier um eine beispielhafte Liste handelt und wir keinen Anspruch auf Vollständigkeit erheben können. In der Cookie-Erklärung unter&nbsp;
				<a href="https://www.cookiebot.com/de/cookie-declaration/" target="_blank" rel="follow noopener noreferrer">
			...
			<br></br>
			<p>
				<b>Wie lange und wo werden die Daten gespeichert?</b>
			</p>
			<br></br>
			<p>
				Alle erhobenen Daten werden ausschließlich innerhalb der Europäischen Union übertragen, gespeichert und weitergeleitet. Die Daten werden in einem Azure-Rechenzentrum (Cloud-Anbieter ist Microsoft) gespeichert. Auf{" "}
				<a href="https://azure.microsoft.com/de-de/explore/global-infrastructure/geographies/" target="_blank" rel="follow noopener">
					https://azure.microsoft.com/de-de/explore/global-infrastructure/geographies/
				</a>{" "}
				erfahren Sie mehr über alle „Azure-Regionen“. Alle User Daten werden von Cookiebot nach 12 Monaten ab der Registrierung (Cookie-Zustimmung) bzw. unmittelbar nach Kündigung des Cookiebot-Services gelöscht.
			</p>
			<br></br>
			<p>
				<b>Wie kann ich meine Daten löschen bzw. die Datenspeicherung verhindern?</b>
			</p>
			<br></br>
			...
			<br></br>
			<h4 id="weihnachtsraetsel">7. Weihnachtsrätsel</h4>
			<br></br>
			<h5>Teilnahmebedingungen</h5>
			<br></br>
			<p>Die Teilnahme am Weihnachtsrätsel der Jugendteam des Eifelvereins Rheinbach, nachfolgend Betreiber oder Veranstalter genannt, ist kostenlos und richtet sich ausschließlich nach diesen Teilnahmebedingungen.</p>

			<br></br>
			<h5>Ablauf des Weihnachtsrätsels</h5>
			<br></br>
			<p>Die Dauer des Weihnachtsrätsels erstreckt sich vom 23.12.2023, 00.00 Uhr bis zum 07.01.2024, 23.59 Uhr. Innerhalb dieses Zeitraums erhalten Nutzer online die Möglichkeit, am Weihnachtsrätsel teilzunehmen.</p>

			<br></br>
			<h5>Teilnahme</h5>
			<br></br>
			<p>Um am Weihnachtsrätsel teilzunehmen, ist ein Ausfüllen und Absenden des angezeigten Teilnahmeformulars notwendig. Die Teilnahme ist nur innerhalb des Teilnahmezeitraums möglich. Nach Teilnahmeschluss eingehende Einsendungen werden bei der Auslosung nicht berücksichtigt. Pro Teilnehmer nimmt nur eine übermittelte Anmeldung am Gewinnspiel teil. Es ist strengstens untersagt, mehrere Email-Adressen zur Erhöhung der Gewinnchancen zu verwenden. Die Teilnahme am Weihnachtsrätsel ist kostenlos.</p>

			<br></br>
			<h5>Teilnahmeberechtigte</h5>
			<br></br>
			<p>Teilnahmeberechtigt sind natürliche Personen, die Ihren Wohnsitz in Deutschland und das 14. Lebensjahr vollendet haben. Die Teilnahme ist nicht auf Mitglieder des Eifelvereins Rheinbach beschränkt und nicht vom Erwerb einer Ware oder Dienstleistung abhängig. Sollte ein Teilnehmer in seiner Geschäftsfähigkeit eingeschränkt sein, bedarf es der Einwilligung seines gesetzlichen Vertreters. Nicht teilnahmeberechtigt am Gewinnspiel sind alle an der Konzeption und Umsetzung des Weihnachtsrätsels beteiligte Personen, Vorstand und Jugendteamer des Eifelvereins Rheinbach sowie ihre Familienmitglieder. Zudem behält sich der Betreiber des Weihnachtsrätsels vor, nach eigenem Ermessen Personen von der Teilnahme auszuschließen, wenn berechtigte Gründe vorliegen, beispielsweise (a) bei Manipulationen im Zusammenhang mit Zugang zum oder Durchführung des Weihnachtsrätsels, (b) bei Verstößen gegen diese Teilnahmebedingungen, (c) bei unlauterem Handeln oder (d) bei falschen oder irreführenden Angaben im Zusammenhang mit der Teilnahme an dem Weihnachtsrätsel.</p>

			<br></br>
			<h5>Gewinn, Benachrichtigung und Übermittlung des Gewinns</h5>
			<br></br>
			<p>Folgende Preise werden verlost: Ein schwarzer Wanderrucksack der Firma Quechua. Ein T-Shirt (Größe frei wählbar) der Wanderjugend Rheinbach. Ein Spiel „NOOBS“ der Firma KOSMOS. Die Ermittlung der Gewinner erfolgt nach Teilnahmeschluss im Rahmen einer auf dem Zufallsprinzip beruhenden Verlosung unter allen Teilnehmern. Das Weihnachtsrätsel ist mit einer Aufgabe verknüpft, daher kommen ausschließlich diejenigen Teilnehmer in die Verlosung, welche die Aufgabe korrekt durchgeführt haben. Die Gewinner der Verlosung werden zeitnah über eine gesonderte Email über den Gewinn informiert. Die Aushändigung des Gewinns erfolgt ausschließlich an den Gewinner oder an den gesetzlichen Vertreter des minderjährigen Gewinners. Ein Umtausch sowie eine Barauszahlung des Gewinns sind nicht möglich. Mit der Inanspruchnahme des Gewinns verbundene Zusatzkosten gehen zu Lasten des Gewinners. Für eine etwaige Versteuerung des Gewinns ist der Gewinner selbst verantwortlich. Meldet sich der Gewinner nach zweifacher Aufforderung innerhalb einer Frist von 3 Wochen nicht, kann der Gewinn auf einen anderen Teilnehmer übertragen werden.</p>

			<br></br>
			<h5>Beendigung des Weihnachtsrätsels</h5>
			<br></br>
			<p>Der Veranstalter behält sich ausdrücklich vor, das Weihnachtsrätsel ohne vorherige Ankündigung und ohne Mitteilung von Gründen zu beenden. Dies gilt insbesondere für jegliche Gründe, die einen planmäßigen Ablauf des Weinachtsrätsels stören oder verhindern würden.</p>

			<br></br>
			<h5>Datenschutz</h5>
			<br></br>
			<p>Für die Teilnahme am Weihnachtsrätsel ist die Angabe von persönlichen Daten notwendig. Der Teilnehmer versichert, dass die von ihm gemachten Angaben zur Person, insbesondere Vor-, Nachname und Emailadresse wahrheitsgemäß und richtig sind. Der Veranstalter weist darauf hin, dass sämtliche personenbezogene Daten des Teilnehmers ohne Einverständnis weder an Dritte weitergegeben noch diese zur Nutzung überlassen werden. Der Teilnehmer kann seine erklärte Einwilligung jederzeit widerrufen. Der Widerruf ist schriftlich an die im Impressumsbereich des Weihnachtsrätsels angegebenen Kontaktdaten des Veranstalters zu richten. Nach Widerruf der Einwilligung werden die erhobenen und gespeicherten personenbezogenen Daten des Teilnehmers umgehend gelöscht.</p>

			<br></br>
			<h5>Anwendbares Recht</h5>
			<br></br>
			<p>Fragen oder Beanstandungen im Zusammenhang mit dem Weihnachtsrätsel sind an den Betreiber zu richten. Kontaktmöglichkeiten finden sich im Impressumsbereich des Weihnachtsrätsels. Das Gewinnspiel des Betreibers unterliegt ausschließlich dem Recht der Bundesrepublik Deutschland. Der Rechtsweg ist ausgeschlossen.</p>

			<br></br>
			<h5>Salvatorische Klausel</h5>
			<br></br>
			<p>Sollte eine Bestimmung dieser Teilnahmebedingungen ganz oder teilweise unwirksam sein oder werden, so wird dadurch die Gültigkeit dieser Teilnahmebedingungen im Übrigen nicht berührt. Statt der unwirksamen Bestimmung gilt diejenige gesetzlich zulässige Regelung, die dem in der unwirksamen Bestimmung zum Ausdruck gekommenen Sinn und Zweck wirtschaftlich am nächsten kommt. Entsprechendes gilt für den Fall des Vorliegens einer Regelungslücke in diesen Teilnahmebedingungen. Viel Glück und Erfolg wünscht das Jugendteam des Eifelvereins Rheinbach. </p>
		</main>
	);
}
