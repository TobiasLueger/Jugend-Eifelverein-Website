	...
	return (
		<main className="pt-[116px]">
			...
			<p>
				...
				verschiedene Logfiles inklusive Ihrer IP-Adressen. Weitere Informationen
			...
			<p>
				...
				personenbezogenen Daten zu verlangen. Wenn Sie die Verarbeitung Ihrer
			...
			<p>
				...
				Webbrowser erfolgt. Cookies können von uns (First-Party-Cookies) oder
				von Drittunternehmen stammen (sog. Third-PartyCookies).
				...
				Cookies zur Abwicklung von Zahlungsdienstleistungen). Cookies haben
				verschiedene Funktionen. Zahlreiche Cookies sind technisch notwendig, da
				bestimmte Webseitenfunktionen ohne diese nicht funktionieren würden (z.
				B. die Warenkorbfunktion oder die Anzeige von Videos). Andere Cookies
				...
				dieser Einwilligung (Art. 6 Abs. 1 lit. a DSGVO und § 25 Abs. 1 TTDSG);
				die Einwilligung ist jederzeit widerrufbar. Sie können Ihren Browser so
				...
				eingeschränkt sein. Welche Cookies und Dienste auf dieser Website
				eingesetzt werden, können Sie dieser Datenschutzerklärung entnehmen.
			</p>
			<br></br>
			...
			<br></br>
			<p>
				Wir verwenden auf unserer Website CleverReach, ein Dienst für unser
				...
				<br></br>
				Mehr über die Daten, die durch die Verwendung von CleverReach
				verarbeitet werden, erfahren Sie in der Datenschutzerklärung auf{" "}
				<a
					href="https://www.cleverreach.com/de-de/datenschutz/?tid=331673118835"
					target="_blank"
					rel="follow noopener"
				>
			...
			<p>
				...
				Kopenhagen, DK. Cookiebot bietet uns unter anderem die Möglichkeit,
				Ihnen einen umfangreichen Cookie-Hinweis (auch Cookie-Banner oder
				Cookie-Notice genannt) zu liefern. Durch die Verwendung dieser Funktion
				können Daten von Ihnen an Cookiebot bzw. Cybot gesendet, gespeichert und
				verarbeitet werden. In dieser Datenschutzerklärung informieren wir Sie
				warum wir Cookiebot nutzen, welche Daten übertragen werden und wie Sie
				diese Datenübertragung verhindern können.
			</p>
			<p>
				Cookiebot ist ein Software-Produkt des Unternehmens Cybot. Die Software
				erstellt automatisch einen DSGVO-konformen Cookie-Hinweis für unserer
			...
			<p>
				...
				was auf unserer Website vor sich geht und welche Ihrer Daten gespeichert
				werden. Cookiebot hilft uns einen guten Überblick über all unsere
			...
			<br></br>
			<p>
				Wenn Sie Cookies zulassen, werden folgende Daten an Cybot übertragen,
				gespeichert und verarbeitet.
			</p>
			<ul>
				<li>
					IP-Adresse (in anonymisierter Form, die letzten 3 Ziffern werden auf 0
					gesetzt)
				</li>
			...
			<p>
				Folgenden Cookies werden von Cookiebot gesetzt, wenn Sie der Verwendung
				von Cookies zugestimmt haben:
			</p>
			<p>
				<strong>Name:</strong>&nbsp;CookieConsent<br></br>{" "}
				<strong>Wert:</strong>
				&nbsp;stamp:’P7to4eNgIHvJvDerjKneBsmJQd9331673119131-2<br></br>{" "}
				<strong>Verwendungszweck:</strong>&nbsp;In diesem Cookie wird Ihr
				Zustimmungsstatus, gespeichert. Dadurch kann unsere Website auch bei
				zukünftigen Besuchen den aktuellen Status lesen und befolgen.<br></br>{" "}
				<strong>Ablaufdatum:</strong>&nbsp;nach einem Jahr
			</p>
			<p>
				<strong>Name:</strong>&nbsp;CookieConsentBulkTicket<br></br>{" "}
				<strong>Wert:</strong>
				&nbsp;kDSPWpA%2fjhljZKClPqsncfR8SveTnNWhys5NojaxdFYBPjZ2PaDnUw%3d%3331673119131-6
				<br></br> <strong>Verwendungszweck:</strong>&nbsp;Dieses Cookie wird
				gesetzt, wenn Sie alle Cookies erlauben und somit eine
				“Sammelzustimmung” aktiviert haben. Das Cookie speichert dann eine
				eigene, zufällige und eindeutige ID.<br></br>{" "}
				<strong>Ablaufdatum:&nbsp;</strong>nach einem Jahr
			</p>
			<p>
				<strong>Anmerkung: </strong>Bitte bedenken Sie, dass es sich hier um
				eine beispielhafte Liste handelt und wir keinen Anspruch auf
				Vollständigkeit erheben können. In der Cookie-Erklärung unter&nbsp;
				<a
			...
			<br></br>
			<p>
				Alle erhobenen Daten werden ausschließlich innerhalb der Europäischen
				Union übertragen, gespeichert und weitergeleitet. Die Daten werden in
				einem Azure-Rechenzentrum (Cloud-Anbieter ist Microsoft) gespeichert.
				Auf{" "}
				<a
					href="https://azure.microsoft.com/de-de/explore/global-infrastructure/geographies/"
					target="_blank"
					rel="follow noopener"
				>
					https://azure.microsoft.com/de-de/explore/global-infrastructure/geographies/
				</a>{" "}
				erfahren Sie mehr über alle „Azure-Regionen“. Alle User Daten werden von
			...
			<p>
				...
				können Sie beispielsweise verhindern, indem Sie über den Cookie-Hinweis
			...
			<p>
				...
				Ihnen die Einwilligung ermöglichen zu können, kommt der Cookiebot zum
				Einsatz. Der Einsatz dieser Software ermöglicht uns, die Website auf
				effiziente Weise rechtskonform zu betreiben, was ein{" "}
				<strong>berechtigtes Interesse</strong> (Artikel 6 Abs. 1 lit. f DSGVO)
				darstellt.
			</p>
			<p>
				Wenn Sie mehr über die Datenschutzrichtlinien von „Cookiebot“ bzw. dem
				dahinterstehenden Unternehmen Cybot erfahren wollen, empfehlen wir Ihnen
				die Datenschutzrichtlinien unter{" "}
				<a
					href="https://www.cookiebot.com/de/privacy-policy/?tid=331673119131"
					target="_blank"
			...
			<p>
				...
				benötigen wir von Ihnen eine EMail-Adresse sowie Informationen, welche
				...
				lit. f DSGVO zu löschen oder zu sperren. Daten, die zu anderen Zwecken
				bei uns gespeichert wurden, bleiben hiervon unberührt. Nach Ihrer
				Austragung aus der Newsletterverteilerliste wird Ihre E-Mail-Adresse bei
				uns bzw. dem Newsletterdiensteanbieter ggf. in einer Blacklist
			...
			<p>
				...
				Analyse stattfindet. Die Speicherung und Analyse der Daten erfolgt auf
				...
				jederzeit widerrufbar. Weitere Informationen zu Google reCAPTCHA
